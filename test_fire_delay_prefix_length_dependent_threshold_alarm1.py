...
method = "fire_delay_prefix_length_alarm1"
...
with open(out_filename, 'w') as fout:
    ...
    c_com_weights = [0, 1, 2, 3, 4, 5, 10, 20,30,40]
    c_postpone_weight = 0
        ...
        for c_com_weight in c_com_weights:
            for early_type in ["const", "linear", "nonmonotonic"]:
                ...
                with open(conf_file, "rb") as fin:
                    conf_params = pickle.load(fin)
                    conf_thresholds = conf_params['conf_threshold']
                    myopic_param = conf_params['myopic_param']
                    prefix_threshold = conf_params['prefix_threshold']
                ...
                writer.writerow(
                    [dataset_name, method, "fire_delay", myopic_param, c_miss_weight, c_action_weight, c_postpone_weight, c_com_weight,
                     early_type, conf_thresholds])
                writer.writerow([dataset_name, method, "prec", prec, c_miss_weight, c_action_weight, c_postpone_weight,
                                 c_com_weight, early_type, conf_thresholds])
                writer.writerow(
                ...
                writer.writerow(
                    [dataset_name, method, "earliness_mean", earliness.mean(), c_miss_weight, c_action_weight,
                     c_postpone_weight, c_com_weight, early_type, conf_thresholds])
                ...
                writer.writerow([dataset_name, method, "earliness_alarms_mean", earliness_alarms.mean(), c_miss_weight,
                                 c_action_weight, c_postpone_weight, c_com_weight, early_type, conf_thresholds])
