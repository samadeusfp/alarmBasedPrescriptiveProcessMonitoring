    ...
    for c_miss_weight, c_action_weight in cost_weights:
        for c_com_weight in c_com_weights:
            for early_type in ["const","linear","nonmonotonic"]:
                ...
                conf_file_0_vs_1 = os.path.join(conf_threshold_dir, "0_vs_1/",
                ...
                # load the optimal confidence threshold
                conf_file_0_vs_2 = os.path.join(conf_threshold_dir, "0_vs_2/",
                                                "optimal_confs_%s_%s_%s_%s_%s_%s.pickle" % (
                                                    dataset_name, c_miss_weight, c_action_weight, c_postpone_weight,
                                                    c_com_weight, early_type))
                # load the optimal confidence threshold
                conf_file_1_vs_2 = os.path.join(conf_threshold_dir, "0_vs_2/",
                                                "optimal_confs_%s_%s_%s_%s_%s_%s.pickle" % (
                                                    dataset_name, c_miss_weight, c_action_weight, c_postpone_weight,
                                                    c_com_weight, early_type))
