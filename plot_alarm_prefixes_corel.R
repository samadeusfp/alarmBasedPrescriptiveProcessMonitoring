...
setwd("/Users/stephanf/Dropbox/Dokumente/Masterstudium/Masterthesis/testresults/NonMyopicRanking/")
files <- list.files()
data <- data.frame()
for (file in files) {
...
ggsave("/Users/stephanf/Dropbox/Dokumente/Masterstudium/Masterthesis/testresults/NonMyopic/result_heatmap_corel_prefix.pdf", width = 20, height = 13)
